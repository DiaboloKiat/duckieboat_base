...
class Robot_PID():
	def __init__(self):
		...
		self.station_keeping_dis = rospy.get_param('~distance',3.5)
		self.final_goal = rospy.get_param('~goal',[11,3]) 			# enter your pose keeping point here
		...
		if self.sim:
			...
			self.pub_heading = rospy.Publisher("localization_gps_imu/pub2moos/VEH_HEADING",Float64, queue_size=1)
