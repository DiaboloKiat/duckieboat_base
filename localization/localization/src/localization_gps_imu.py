...
class LocailizationGPSImu(object):
    def __init__(self):
        ...
        self.pub_y = rospy.Publisher("~pub2moos/VEH_Y",Float64, queue_size=1)
        #self.pub_heading = rospy.Publisher("~pub2moos/VEH_HEADING",Float64, queue_size=1)
        self.pub_speed = rospy.Publisher("~pub2moos/VEH_SPEED",Float64, queue_size=1)
        self.pub_pitch = rospy.Publisher("~pub2moos/VEH_PITCH",Float64, queue_size=1)
